...
<title>Dashboard &mdash; CodiePie</title>
...
<link rel="stylesheet" href="{{url('Backend/assets/modules/owlcarousel2/dist/assets/owl.carousel.min.css')}}">
<link rel="stylesheet" href="{{url('Backend/assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css')}}">

<!-- Template CSS -->
<link rel="stylesheet" href="{{url('Backend/assets/css/style.min.css')}}">
<link rel="stylesheet" href="{{url('Backend/assets/css/components.min.css')}}">
...
<!-- General JS Scripts -->
<script src="{{url('Backend/assets/bundles/lib.vendor.bundle.js')}}"></script>
<script src="{{url('Backend/js/CodiePie.js')}}"></script>

<!-- JS Libraies -->
<script src="{{url('Backend/assets/modules/jquery.sparkline.min.js')}}"></script>
<script src="{{url('Backend/assets/modules/chart.min.js')}"></script>
<script src="{{url('Backend/assets/modules/owlcarousel2/dist/owl.carousel.min.js')}"></script>
